...
class Test extends CI_Controller {
	...
	public function getStoremanGroup()
	{
		echo '<pre>';
		print_r($this->_getStoremanGroupList());
	}
    ...
    public function sum_reward($epoch_start=0, $epoch_stop=0, $sort='ratio',$invested=1000)
    {
        ...
        echo '=============================';
        echo '<table><thead><tr><th>V.Name</th><th>Selected (Epochs / Jobs)</th><th>EL / RNP</th><th>Validator Reward</th><th>Delegator Reward</th><th>Est. Reward of Invested 100 WAN</th><th>Est. Reward of Invested '.number_format($invested).' WAN</th></tr></thead><tbody>';
		$rank = 0;
        foreach($validators as $address=>$validator)
        {
            ...
            echo '<tr>';
			$rank++;
            echo '<td>'.$rank.'.'.(isset($info['name'])?$info['name']:$info).'</td>';
            echo '<td>'.$validator['epoch_selected'].' Epoch | '.number_format($validator['working_selected']).' Times</td>';
